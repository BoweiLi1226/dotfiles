		...
		keys = function()
			...
			return {
				...
				},
				{
					...
					desc = "Goto Type Definitions - fzf",
				},
				{
					"gO",
					function()
				...
				},
				{
					...
					desc = "Live Workspace Symbols - fzf",
				},
				{
					"<leader>sd",
					function()
	...
	},
	{
		...
		keys = {
			...
			},
			{
				...
				desc = "Goto T[y]pe Definition (Telescope)",
			},
			{
				"<leader>sS",
				function()
			...
			},
			{
				...
				desc = "Diagnostics for buffers (Telescope)",
			},
			{
				"<leader>sb",
				function()
			...
			},
			{
				...
				desc = "List command history (Telescope)",
			},
			{
				"<leader>sC",
				function()
			...
			},
			{
				...
				desc = "List normal mode keymaps (Telescope)",
			},
			{
				"<leader>sm",
				function()
				...
				desc = "List marks and their value (Telescope)",
			},
